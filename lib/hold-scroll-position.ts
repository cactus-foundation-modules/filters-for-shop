...
// Grows the filtered product grid without moving the page.
//
// Its own copy rather than an import from shop, like FilterShell's page-number
// window: a new file imported across modules would tie this module's release
// to a shop release, for twenty lines.
//
